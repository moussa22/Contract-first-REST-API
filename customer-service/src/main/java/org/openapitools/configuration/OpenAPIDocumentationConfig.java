...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("http://rdonfack.developpez.com/")
            .version("v2")
            .contact(new Contact("","", "hinault@monsite.com"))
            .build();
    }

    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.swaggerDemo.base-path:}") String basePath) {
